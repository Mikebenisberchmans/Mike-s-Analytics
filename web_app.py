...
def unique_df(df):
    ...
    return data
st.set_page_config(page_title='Ur.cristiano-(EDA)', layout='wide')
st.markdown(
    """
    <style>
    .stApp h1 {
...
st.sidebar.image('cristiano_poster2.jpg', use_column_width=True)
...
image_base64 = get_base64_image("sidebar_bw_potriat.jpg")
...
if selections == 'introduction':
    ...
    image_base64 = get_base64_image("intro_bg.jpg")
    ...
    st.markdown('</center>',unsafe_allow_html=True)
    # st.text('')
    st.image('career_journey.jpg',use_column_width=True)
    st.markdown(
    ...
    #     '<h3 style="color:yellow;">Current Club:Al nassr</h3>',
        # unsafe_allow_html=True
     # )
    st.image("trophies.jpg",use_column_width=True)
